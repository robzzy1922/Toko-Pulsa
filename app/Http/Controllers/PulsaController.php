...
class PulsaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('content.admin.pulsa.manage-pulsa',  compact('pulsa'));
    }
    ...
    public function create()
    {
        ...
        return view('content.admin.pulsa.manage-pulsa-create', compact('provider'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('content.admin.pulsa.manage-user-pulsa', compact('pulsa'));
    }
