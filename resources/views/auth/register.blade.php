...
<head>
    ...
    <!-- TITLE -->
    <title>Robi Cell - Register</title>
            ...
            <div class="">
                ...
                <div class="mx-auto col col-login mt-7">
                    <div class="text-center">
                        <img src="assets/images/brand/logo-white.png" class="m-0 header-brand-img" alt="">
                    </div>
                </div>
                    ...
                    <div class="p-6 wrap-login100">
                        <form class="login100-form validate-form" action="{{ route('register-process') }}" method="POST">
                            ...
                            <div class="pt-3 text-center">
                                <p class="mb-0 text-dark">Already have account?<a href="login.html" class="text-primary ms-1">Sign In</a></p>
                            </div>
